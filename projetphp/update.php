...
$errorMsg ="";
    ...
    if ($_SERVER['REQUEST_METHOD']=='GET'){
        $sql = "SELECT id, firstname, lastname,password FROM Clients WHERE id='$_GET[idUpdated]'";
...
$fnameValue=$row['firstnameValue'];
$lnameValue=$row['lastnameValue'];
        ...
        if(empty($fnameValue)|| ($lnameValue)|| ($emailValue)){
...
$sql = "UPDATE Clients SET firstname = '$fnameValue', lastname= '$lnameValue', email='$emailValue ' WHERE id='$_GET[idUpdated]'" ;
